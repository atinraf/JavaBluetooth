/*
 * modified by Thomas de Lazzari
 * http://tdelazzari.blogspot.com
 *
 */
package bluetoothscan;
 ...
 *
 * Connects to the chosen device and checks for the presence of service in it.
...
public class BluetoothServiceDiscovery implements DiscoveryListener {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (deviceCount <= 0) {
            ...
            //print bluetooth device addresses and names
        ...
        if (connectionURL == null) {
            System.out.println("Device does not have a bluetooth server listening in a BTSPP url");
        } else {
